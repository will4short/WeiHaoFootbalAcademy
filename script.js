const translations = {
  zh: {
    skip:'跳至主要內容',brandSub:'足球學院',navMethod:'訓練方法',navPrograms:'課程',navCoach:'教練',navExperience:'學院體驗',navContact:'聯絡我們',bookTrial:'預約試堂',menu:'選單',
    ...
    contactEyebrow:'第一堂訓練由此開始',contactTitle:'準備看看 Kick & Speak 是否適合您的孩子？',contactLead:'Kick & Speak 足球學院正在籌備於台灣開辦課程，現正考慮台北、新北及新竹。告訴我們您的家庭所在地，一起塑造首批訓練組別。',whatsapp:'透過 WhatsApp 聯絡',responseNote:'歡迎以英語或繁體中文作開辦前查詢。',parentName:'家長／監護人姓名',email:'電郵地址',playerAge:'球員年齡',phoneLabel:'電話／WhatsApp',cityLabel:'首選城市',chooseCity:'選擇城市',anotherCity:'其他城市',programLabel:'感興趣的課程',chooseProgram:'選擇課程',notSure:'暫時不確定',messageLabel:'還有甚麼需要讓我們知道？',messagePlaceholder:'經驗、目標、合適日子或問題',sendEnquiry:'準備試堂查詢',formHelp:'提交後會開啟您的電郵程式並填好查詢內容。本網站不會儲存任何資料。',
